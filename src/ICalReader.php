...
class ICalReader
{
     ...
     * @param $keyword
     * @param $value
     * @internal param $ {string} $component This could be VTODO, VEVENT, VCALENDAR, ...
     * @internal param $ {string} $keyword   The keyword, for example DTSTART
     * @internal param $ {string} $value     The value, for example 20110105T090000Z
     *
     * @return void {None}
     */
     ...
     *
     * @return array|bool|null {array} array("VCALENDAR", "Begin")
     */
     ...
     * @param bool $rangeEnd
     * @internal param $ {boolean} $rangeStart Either true or false
     * @internal param $ {boolean} $rangeEnd   Either true or false
     *
     ...
     *
     * @param int $sortOrder
     * @return array|mixed|null {boolean}
     */
